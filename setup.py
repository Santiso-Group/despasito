...
setup(
    ...
    setup_requires=["jax","numpy","scipy",,"matplotlib"] + pytest_runner,
    ext_package=fpath,
    ...
    install_requires=["jax","numpy","scipy","deap","numba","matplotlib"],              # Required packages, pulls from pip if needed; do not use for Conda deployment
    # platforms=['Linux',
    #            'Mac OS-X',
    #            'Unix',
