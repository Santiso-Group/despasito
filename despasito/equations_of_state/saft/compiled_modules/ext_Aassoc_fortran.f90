subroutine calc_Xika_inner(Xika0,indices,xi,rho,nui,nk,Fklab,Kklab,Iij,obj_func,Xika,ncomp,nbeads,nsitemax,nind)
    implicit none
...
subroutine calc_Xika(indices,rho,Xika_init,xi,nui,nk,Fklab,Kklab,Iij,maxiter,tol,Xika_final,nrho,ncomp,nbeads,nsitemax,nind)
    implicit none
    ...
    do i=0, nrho-1
        ...
        do iter=0, maxiter-1
            Xika0=Xika
            call calc_Xika_inner(Xika0,indices,xi,rho(i),nui,nk,Fklab,Kklab,Iij(i,:,:),obj_func,Xika,ncomp,nbeads,nsitemax,nind)            
