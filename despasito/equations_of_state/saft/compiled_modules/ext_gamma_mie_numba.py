...
@numba.njit(numba.f8[:,:](numba.f8[:],numba.f8[:],numba.f8, numba.f8[:], numba.f8[:], numba.f8[:], numba.f8[:]))
...
@numba.njit(numba.f8[:,:,:](numba.f8[:], numba.f8, numba.f8[:,:], numba.f8[:,:], numba.f8[:,:], numba.f8[:,:], numba.f8[:,:], numba.f8[:]))
def calc_a1ii(rho, Cmol2seg, dii_eff, l_aii_avg, l_rii_avg, x0ii, epsilonii_avg, zetax):
    ...
    Cii = prefactor_2d(l_rii_avg, l_aii_avg)
...
def calc_da1sii_drhos(rho, Cmol2seg, l_kl, zetax, epsilonkl, dkl):
    ...
    for k in range(nbeads):
        cikl = np.dot(ckl_coef, np.array( (1.0, 1.0/l_kl[k], 1.0/l_kl[k]**2, 1.0/l_kl[k]**3), dtype=ckl_coef.dtype ) )
