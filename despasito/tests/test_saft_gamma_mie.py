...
epsilonHB_co2_h2o = np.array([[[[   0.,     0.,     0. ], \
                     ...
                     [[[   0.,     0.,     0. ], \
                      ...
                      [[   0.,  1985.4,    0. ], \
                       [1985.4,    0.,     0. ], \
                       [   0.,     0.,     0. ]]]])
eos_co2_h2o = despasito.equations_of_state.eos(eos="saft.gamma_mie",beads=beads_co2_h2o,nui=nui_co2_h2o,beadlibrary=copy.deepcopy(beadlibrary_co2_h2o),crosslibrary=copy.deepcopy(crosslibrary_co2_h2o),sitenames=sitenames_co2_h2o)
T = 323.2 
...
#   """Test ability to create EOS object with association sites"""
    eos_class = despasito.equations_of_state.eos(eos="saft.gamma_mie",beads=beads,nui=nui,beadlibrary=copy.deepcopy(beadlibrary),crosslibrary=copy.deepcopy(crosslibrary),sitenames=sitenames)
