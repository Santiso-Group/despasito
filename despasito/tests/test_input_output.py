...
def test_process_bead_data(data):
    ...
    elif not np.array_equal(molecular_composition,np.array([[1.,0.],[0.,2.]])):
        errors.append("molecular_composition: %s is not %s" % (str(molecular_composition),str(np.array([[1.,0.],[0.,2.]]))))
