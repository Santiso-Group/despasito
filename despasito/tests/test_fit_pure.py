...
exp_data_sat = {'Wiley': {'data_class_type': 'saturation_properties', "eos_obj":Eos, 'calculation_type': 'saturation_properties', 'T': np.array([200.]), 'Psat': np.array([6.1000e+01]), 'rhol': np.array([27474.40699]), 'rhov': np.array([3.12109900e-03])}, 
            'Gibbard': {'data_class_type': 'saturation_properties', "eos_obj":Eos, 'calculation_type': 'saturation_properties', 'T': np.array([288.1506]), 'Psat': np.array([ 9884.4])}}
...
exp_data_density = {'Wiley': {'data_class_type': 'liquid_density', "eos_obj":Eos, 'calculation_type': 'liquid_properties', 'T': np.array([288.1506]), 'P': np.array([11152.285]), 'rhol': np.array([24098.4771])}}

## Optimization options
optimization_parameters = {"fit_bead" : "CH3OH", "fit_params": ["epsilon"], "epsilon_bounds" : [300.0, 400.0]}
thermo_dict0 = {"optimization_parameters": optimization_parameters, "beadparams0": [384.0], "global_opts": {"method": "single_objective"}}
