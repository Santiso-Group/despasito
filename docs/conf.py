...
MOCK_MODULES = ['deap', 'solv_assoc', 'solv_assoc_matrix',"importlib"]
...
project = 'DESPASITO'
copyright = ("2019, Jennifer A Clark. Project structure based on the "
...
latex_documents = [
    (master_doc, 'despasito.tex', 'DESPASITO Documentation',
     'despasito', 'manual'),
]
